...
type GreeterClient interface {
	...
	SayHelloAgain(ctx context.Context, in *GoodByeRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *GoodByeRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
type GreeterServer interface {
	...
	SayHelloAgain(context.Context, *GoodByeRequest) (*HelloReply, error)
...
func (UnimplementedGreeterServer) SayHelloAgain(context.Context, *GoodByeRequest) (*HelloReply, error) {
...
func _Greeter_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayHelloAgain(ctx, req.(*GoodByeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
